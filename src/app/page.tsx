    ...
    <div className="flex flex-col gap-8 md:gap-12">
      ...
      <section className="container mx-auto px-16">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-3xl font-bold font-headline">Informasi Terbaru</h2>
      ...
      <section className="container mx-auto px-16">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-3xl font-bold font-headline">Informasi Terpopuler</h2>
          <Button variant="outline" asChild>
            <Link href="/knowledge">Lihat Semua <ArrowRight className="ml-2 h-4 w-4" /></Link>
          </Button>
        </div>
       ...
       <section className="bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 py-16 md:py-20 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Button asChild size="lg" className="bg-white text-accent-foreground hover:bg-transparent hover:text-white hover:border-white border-2 border-transparent transition-colors">
